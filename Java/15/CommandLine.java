...
public class CommandLine {
	...
	private static boolean printCustomerTable(ResultSet rs) throws Exception {
		...
		while (rs.next()) {
			...
			boolean sub = rs.getBoolean("Subscription");
			String unday = rs.getString("Day Unavailable");
			...
			System.out.printf("%30s", sub);
			System.out.printf("%30s", unday);
			System.out.printf("%30s", sus);
			System.out.println();
		}// end while
		System.out.println("--------------------------------------------------------------------------------------------------------------------------------------");
